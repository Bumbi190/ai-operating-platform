/**
 * `/memory` — the legacy memory body, moved verbatim.
 *
 * This is the rollback target for `?ui=legacy`. The previous page follows with
 * only two mechanical edits: segment config moved to `page.tsx`, and the
 * default export became a named export. A regression test pins its body hash.
 * Do not repair its first-project fallback or its write controls here.
 */
...
export async function MemoryLegacy() {
