/**
 * Cost Intelligence — Omnira (P0: sektion i /revenue, tidigare egen sida /costs)
 *
...
export async function CostIntelligence() {
  ...
  return (
    <section id="kostnader" className="space-y-6">
      <LiveRefresh seconds={20} />

      {/* ── SEKTIONSRUBRIK (P0: tidigare sidhero) ───────────────────────── */}
      <OSLayer layer="intelligence">
        <div>
          <p className="eyebrow eyebrow-accent mb-1">Cost Intelligence</p>
          <h2 className="text-xl font-bold tracking-tight">Kostnader</h2>
