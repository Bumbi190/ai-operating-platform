/**
 * `/system` before vNext — the Systemtelemetri body, moved here verbatim.
 *
 * Reachable at `?ui=legacy` (or with the `omnira_ui=legacy` cookie). Nothing in
 * it changed in the move: the same scoped reads, the same instruments, the same
 * derived readings — including the `100 - failRate * 2` health number that
 * Systemhälsa deliberately does not carry forward. The rollback is the page that
...
export async function SystemLegacy() {
