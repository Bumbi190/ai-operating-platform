...
import { igAccountSnapshot, fbAccountSnapshot, type AccountSnapshot } from '@/lib/media/account-insights'
...
export async function GET(request: Request) {
  ...
  async function capture(platform: 'instagram' | 'facebook', snap: AccountSnapshot | null) {
  ...
  await capture('facebook', fb ? await fbAccountSnapshot(fb.accessToken) : null)
