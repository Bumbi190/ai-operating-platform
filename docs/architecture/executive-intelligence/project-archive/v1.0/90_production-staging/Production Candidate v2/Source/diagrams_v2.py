...
KEPT_META={
 "D01":dict(title="Omnira Intelligence Position Model", canonical_sections=["Ch 2 §§2.2-2.3"]),
...
KEPT_FUNCS={"D01":dia_position,"D02":dia_emw,"D10":dia_sev_bound,"D11":dia_autonomy,"D18":dia_stage}
KEPT_DARK={"D01"}  # only D01 is a dark full-page plate among the kept set (matches Candidate v1)
...
CORRECTED={"D03":_c_d03,"D04":_c_d04,"D05":_c_d05,"D06":_c_d06,"D07":_c_d07,"D08":_c_d08,
           "D09":_c_d09,"D12":_c_d12,"D13":_c_d13,"D15":_c_d15,"D16":_c_d16,"D17":_c_d17}

# D14 intentionally excluded from Candidate v2 (REMOVE FROM PROFESSIONAL EDITION — REDUNDANT WITH D01).
EXCLUDED={"D14"}
