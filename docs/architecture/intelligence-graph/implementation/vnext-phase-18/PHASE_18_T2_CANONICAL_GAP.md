...
Last updated: 2026-09-16, at T2a (Canvas First). T2a is built locally, is not pushed, and is waiting for owner QA.
...
| # | Canonical requirement | Book / risk reference | State after T2a | Planned |
|---|---|---|---|---|
...
| G-05 | Atlas and Manager as sourced graph entities with sourced relations | ¶119, ¶373, ¶604 | Absent at T2a. A later T2 sub-step adds Atlas as an identity orb only (decision 1), never as a data node. Manager is not drawn | Needs a source contract |
