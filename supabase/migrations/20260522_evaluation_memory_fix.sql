...
--  Run this in Supabase SQL Editor if 20260522_evaluation_memory.sql
--  failed mid-way (leaves tables in broken state).
--
--  Safe to run on a fresh DB or after a failed partial migration.
--  DROP … IF EXISTS is harmless if tables don't exist yet.
-- ═══════════════════════════════════════════════════════════════════
